...
export default function NewFighter({ onCreated }) {
    ...
    return (
        <div id="new-fighter">
            <div>New Fighter</div>
            <TextField onChange={onNameChange} id="nf-name" label="Standard" placeholder="Name"/>
            <TextField onChange={onPowerChange} id="nf-power" label="Standard" placeholder="Power" type="number" />
            <TextField onChange={onDefenseChange} id="nf-defense" label="Standard" placeholder="Defense" type="number" />
